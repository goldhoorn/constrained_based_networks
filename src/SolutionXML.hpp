...
class SolutionXML
{
   ...
   private:
    ...
    void addConnectionIfNotExist(std::stringstream &s, std::string source, std::string target);
    ...
    std::list<std::string> parseOnlyStates(xmlpp::Element *c, std::stringstream &s);
